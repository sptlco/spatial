...
export const Dropdown = {
  ...
  Content: createElement<typeof Primitive.Content, Primitive.DropdownMenuContentProps>(({ sticky = "always", ...props }, ref) => (
    <Dropdown.Portal>
      <Primitive.Content
        ...
        className={clsx(
          "flex flex-col",
          "bg-background-surface shadow-base rounded-xl overflow-x-hidden w-fit md:w-screen md:max-w-3xs",
   ...
   */
  Icon: createElement<typeof Icon>((props, ref) => <Icon {...props} ref={ref} className={clsx(props.className)} />),
