...
/**
 * Create a new context menu checkbox item element.
 * @param props Configurable options for the element.
 * @returns A context menu checkbox item element.
 */
export const ContextMenuCheckboxItem: Element<ContextMenuCheckboxItemProps> = (
