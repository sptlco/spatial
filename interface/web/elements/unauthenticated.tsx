...
/**
 * Configurable options for an unauthenticated component.
 */
export type UnauthenticatedProps = PropsWithChildren & {
  /**
  ...
  /**
   * Where to redirect authenticated uers.
   */
  redirect: string;
};

/**
 * A component that's only rendered if the user is unauthenticated.
