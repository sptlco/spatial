...
import { DropdownRadioItemProps, Element, Node, Span } from "@spatial/elements";
import clsx from "clsx";

/**
 * Create a new dropdown radio item element.
 * @param props Configurable options for the element.
 * @returns A dropdown radio item element.
 */
export const DropdownRadioItem: Element<DropdownRadioItemProps> = (
