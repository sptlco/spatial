...
import { MenuSubmenuTriggerProps, Element, Icon, Node, Span } from "../../..";
import clsx from "clsx";

/**
 * Create a new menu submenu trigger element.
 * @param props Configurable options for the element.
 * @returns A menu submenu trigger element.
 */
export const MenuSubmenuTrigger: Element<MenuSubmenuTriggerProps> = ({
  inset = true,
  ...props
}: MenuSubmenuTriggerProps): Node => {
  return (
