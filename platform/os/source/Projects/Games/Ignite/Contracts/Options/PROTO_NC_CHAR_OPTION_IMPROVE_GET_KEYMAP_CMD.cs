...
/// <summary>
/// A <see cref="ProtocolBuffer"/> for <see cref="NETCOMMAND.NC_CHAR_OPTION_IMPROVE_GET_KEYMAP_CMD"/>.
/// </summary>
public class PROTO_NC_CHAR_OPTION_IMPROVE_GET_KEYMAP_CMD : ProtocolBuffer
{
    /// <summary>
